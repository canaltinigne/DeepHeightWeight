...
"""
Final layer to obtain mask, joint and weight outputs for U-Net Architecture.
    - Redundant Height Estimation Part (Height Estimation Network is implemented in network.py) 
    - 2D Convolutions.
    - ReLU activation function is used.
...
class FinalBlock(nn.Module):
    ...
    def __init__(self, in_ch, pool_size, h_channel):
        ...
        # Redundant Height Estimation part
